                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form class="needs-validation"
                            action="{{url('private/quanly/suathongtin/'.$nhanvien->id_nhanvien)}}" method="POST"
                            ...
                            <div class="tab-content">
                                                ...
                                                <div class="form-group col-md-3 ml-4">
                                                    ...
                                                    <div>
                                                        ...
                                                        <img src="{{url('admin_asset/assets/images/avatar-1.jpg')}}"
                                                            style="width:250px">
                                                        @endif
                                                        <input type="file" name="Hinh" class="form-control mt-3"
                                                            style="width:250px">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group col-md-8">
                                                    <div class="form-row mb-3">
                                                        <div class="form-group col-md-12">
                                                            ...
                                                            <input type="text" class="form-control mb-3" name="ho_ten"
                                                                placeholder="" value="{{$nhanvien->ho_ten}}"
                                                                readonly="">
                                                        </div>
                                                        ...
                                                        <div class="form-group col-md-6 mb-3">
                                                            ...
                                                            <label class="radio-inline mr-5 ml-5 mt-2">
                                                                <input type="radio" name="gioi_tinh" value="1"
                                                                    style="display: inline" @if($nhanvien->gioi_tinh ==
                                                                1) {{"checked"}} @endif>Nam
                                                            </label>
                                                            <label class="radio-inline mr-5 ml-5 mt-2">
                                                        ...
                                                        <div class="form-group col-md-6">
                                                            <label>Dân tộc</label>
                                                            <select name="dan_toc" class="form-control"
                                                                style="-webkit-appearance: auto;">
                                                                @foreach($dantoc as $dt)
                                                                <option @if($nhanvien->id_dantoc==$dt->id_dantoc)
                                                                    {{"selected"}} @endif
                                                                    value="{{$dt->id_dantoc}}">{{$dt->ten_dan_toc}}
                                                                </option>
                                                                @endforeach
                                                            </select>
                                                        </div>
                                                        <div class="form-group col-md-6 ">
                                                            ...
                                                            <input type="text" class="form-control" name="ton_giao"
                                                                ...
                                                                value="{{$nhanvien->ton_giao}}" required>
                                                        </div>
                                                    </div>
                                                    <div class="form-row mb-3">
                                ...
                                <div id="menu1" class="tab-pane fade">
                                    ...
                                    <div class="form-row mb-3">
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="text" class="form-control" name="sdt_ca_nhan"
                                                placeholder="Nhập số điện thoại cá nhân" value="{{$lh->sdt_ca_nhan}}"
                                                required>
                                        </div>
                                        <div class="form-group col-md-4">
                                            <label>Số Điện Thoại Nhà</label>
                                            <input type="text" class="form-control" name="sdt_nha"
                                                placeholder="Nhập số điện thoại nhà" value="{{$lh->sdt_nha}}" required>
                                        </div>
                                        <div class="form-group col-md-4">
                                            <label for="email_ca_nhan">Email Cá Nhân</label>
                                            <input type="email" class="form-control" name="email_ca_nhan"
                                                placeholder="Nhập email cá nhân" value="{{$lh->email}}" required>
                                        </div>
                                    </div>
                                    <div class="form-row mb-3">
                                        <div class="form-group col-md-3">
                                            <label>Địa chỉ thường trú</label>
                                            <input type="text" class="form-control mb-3" name="dia_chi_thuong_tru"
                                                placeholder="Nhập địa chỉ thường trú"
                                                value="{{$lh->dia_chi_thuong_tru}}" required>
                                        </div>
                                        <div class="form-group col-md-3">
                                            <label>Tỉnh/ Thành phố</label>
                                            <select name="tinh_thuong_tru" class="form-control"
                                                style="-webkit-appearance: auto;" required>
                                                @foreach($tinh as $t)
                                                <option @if($lh->id_tinh_thuong_tru==$t->id_tinh) {{"selected"}} @endif
                                                    value="{{$t->id_tinh}}">{{$t->ten_tinh}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class="form-group col-md-3">
                                            <label>Địa chỉ tạm trú</label>
                                            <input type="text" class="form-control mb-3" name="dia_chi_tam_tru"
                                                placeholder="Nhập địa chỉ tạm trú" value="{{$lh->dia_chi_tam_tru}}"
                                                required>
                                        </div>
                                        <div class="form-group col-md-3">
                                            <label>Tỉnh/ Thành phố</label>
                                            <select name="tinh_tam_tru" class="form-control"
                                                style="-webkit-appearance: auto;" required>
                                                @foreach($tinh as $t)
                                                <option @if($lh->id_tinh_tam_tru==$t->id_tinh) {{"selected"}} @endif
                                                    value="{{$t->id_tinh}}">{{$t->ten_tinh}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                ...
                                <div id="menu2" class="tab-pane fade">
                                    ...
                                    <div class="form-row mb-3">
                                        <div class="form-group col-md-2">
                                            ...
                                            <select name="muc_trinh_do" class="form-control"
                                                style="-webkit-appearance: auto;" required>
                                                <option @if($td->muc_trinh_do=="Đại học") {{"selected"}} @endif
                                                    value="Đại học" ">Đại Học</option>
                                                <option @if($td->muc_trinh_do=="Cao đẳng") {{"selected"}} @endif
                                                    value="Cao đẳng" ">Cao Đẳng</option>
                                                <option @if($td->muc_trinh_do=="Trung Cấp") {{"selected"}} @endif
                                                    value="Trung Cấp" ">Trung Cấp</option>
                                                <option @if($td->muc_trinh_do=="Khác") {{"selected"}} @endif
                                                    value="Khác" ">Khác</option>
                                            </select>
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label for="sdt_ca_nhan">Nơi Đào Tạo</label>
                                            <input type="text" class="form-control" name="noi_dao_tao"
                                                placeholder="Nhập nơi đào tạo" value="{{$td->noi_dao_tao}}" required>
                                        </div>
                                        <div class="form-group col-md-2">
                                            <label>Xếp loại</label>
                                            <select name="xep_loai" class="form-control"
                                                style="-webkit-appearance: auto;" required>
                                                <option @if($td->xep_loai=="Giỏi") {{"selected"}} @endif value="Giỏi"
                                                    >Giỏi</option>
                                                <option @if($td->xep_loai=="Khá") {{"selected"}} @endif value="Khá">Khá
                                                </option>
                                                <option @if($td->xep_loai=="Trung Bình Khá") {{"selected"}} @endif
                                                    value="Trung Bình Khá">Trung Bình Khá</option>
                                                <option @if($td->xep_loai=="Khác") {{"selected"}} @endif
                                                    value="Khác">Khác</option>
                                        ...
                                        <div class="form-group col-md-2">
                                            ...
                                            <input type="number" name="nam_tot_nghiep" class="form-control text-center"
                                                min="2010" max="2020" step="1" value="{{$td->nam_tot_nghiep}}"
                                                required />
                                        </div>
                                    ...
                                    <div class="form-row mb-3">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control" name="nganh_dao_tao"
                                                placeholder="Nhập chuyên ngành đào tạo" value="{{$td->nganh_dao_tao}}"
                                                required>
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label>Chuyên Ngành</label>
                                            <input type="text" class="form-control" name="chuyen_nganh"
                                                placeholder="Nhập chuyên ngành đào tạo" value="{{$td->chuyen_nganh}}"
                                                required>
                                        </div>
                                    ...
                                    <div class="form-row mb-3">
                                        <div class="form-group col-md-12">
                                            ...
                                            <input type="text" class="form-control mb-3" name="chung_chi_khac"
                                                placeholder="Nhập bằng cấp, chứng chỉ khác (cách nhau bằng dấu , hoặc dấu , )"
                                                value="{{$td->chung_chi_khac}}">
                                        </div>
                                    </div>
                                    @endforeach
                                </div>
                                        ...
                                        <div class="form-group col-md-12 mb-3">
                                            ...
                                            <div class="icheck-inline">
                                                ...
                                                <label class="col-md-3 col-xs-6" style="margin: 0 0 10px 0;">
                                                    <input type="checkbox" name="hoso[]" value="{{$dshs->id_hoso}}"
                                                        data-checkbox="icheckbox_minimal-blue" class="icheck" {{
                                                        (in_array($dshs->id_hoso, $ho_so))?"checked":"" }} > {{
                                                    $dshs->ten }} </label>
                                                @endforeach
                                            </div>
                                            @endif
                                    ...
                                    <div class="form-row mb-3">
                                        ...
                                        <div class="form-group col-md-6 mb-3">
                                            ...
                                            <select name="chuc_vu" class="form-control"
                                                style="-webkit-appearance: auto;" id="chuc_vu" required>
                                                <option selected value="">Chọn chức vụ</option>
                                                @foreach($chucvu as $cv)
                                                <option @if($nhanvien->id_chucvu==$cv->id_chucvu) {{"selected"}} @endif
                                                    value="{{$cv->id_chucvu}}">{{$cv->ten_chuc_vu}}</option>
                                                @endforeach
                                            </select>
                                ...
                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 mt-3 ">
                                    <button class="btn btn-primary mr-5" type="submit"><i
                                            class="fa fa-save mr-2"></i>Lưu</button>
                                    <button type="reset" class="btn btn-primary"><i class="fas fa-sync-alt mr-2"></i>Làm
                                        mới</button>
                                </div>
                            </div>
                    </div>
