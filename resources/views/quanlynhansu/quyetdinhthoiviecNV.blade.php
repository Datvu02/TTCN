                ...
                <div class="card">
                    <div class="card-body">
                        <form class="needs-validation"
                            action="{{url('private/quyetdinhthoiviecNV/'.$nhanvien->id_nhanvien)}}" method="POST"
                                ...
                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                                    <div class="form-row mb-3">
                                        ...
                                        <div class="form-group col-md-12">
                                            ...
                                            <textarea class="form-control col-12 " id="ly_do"
                                                name="noi_dung"></textarea>
                                        </div>
                                    </div>
                                    <div
                                        class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 mt-3 d-flex justify-content-between">
                                        <div>
