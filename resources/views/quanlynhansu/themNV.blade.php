        ...
        <div class="row">
            ...
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form class="needs-validation" action="private/laphoso" method="POST"
                            ...
                            <div class="row">
                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                                    ...
                                    <input type="text" class="form-control mb-3" name="ho_ten" placeholder="Nhập họ tên"
                                        value="" required>
                                    ...
                                    <div class="form-row mb-3">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control mb-3" name="dia_chi_thuong_tru"
                                                placeholder="Nhập địa chỉ thường trú" value="">
                                        </div>
                                        <div class="form-group col-md-6">
                                    ...
                                    <div class="form-row mb-3">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control mb-3" name="dia_chi_tam_tru"
                                                placeholder="Nhập địa chỉ tạm trú" value="">
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label>Tỉnh/ Thành phố</label>
                                    ...
                                    <h5 class="card-header mb-3" style="color: blueviolet;">Thông Tin Trình Độ, Bằng Cấp
                                    </h5>
                                    <div class="form-row mb-3">
                                    ...
                                    <div class="form-row mb-3">
                                        <div class="form-group col-md-4 mb-3">
                                            ...
                                            <select name="phong_ban" class="form-control"
                                                style="-webkit-appearance: auto;" id="phong_ban">
                                        ...
                                        <div class="form-group col-md-4 mb-3">
                                            <label>Vị trí</label>
                                            <select name="vi_tri" class="form-control" style="-webkit-appearance: auto;"
                                                id="phong_ban">
                                    ...
                                    <h5 class="card-header mb-3" style="color: blueviolet;">Thông Tin Tài Khoảng Tại
                                        Công Ty</h5>
                                    <div class="form-row mb-3">
                                        <div class="form-group col-md-4">
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="email" class="form-control" name="email"
                                                placeholder="Nhập email" value="@cty.com.vn">
                                        </div>
                                        <div class="form-group col-md-4">
