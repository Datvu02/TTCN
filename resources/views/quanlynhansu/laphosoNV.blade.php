        ...
        <div class="row">
            ...
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form name="myform" class="needs-validation" action="laphoso" method="POST"
                            enctype="multipart/form-data" onsubmit="return validatehoso()">
                                ...
                                <div id="home" class="tab-pane fade in active" style="opacity: 1">
                                    <div class="row">
                                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                                            ...
                                            <input type="text" class="form-control mb-3" id="hoten" name="ho_ten"
                                                ...
                                                <div class="form-group col-md-6 mb-3">
                                                    ...
                                                    <label class="radio-inline mr-5 ml-5 mt-2">
                                                        <input type="radio" name="gioi_tinh" value="1" checked=""
                                                            style="display: inline">Nam
                                                    </label>
                                                    <label class="radio-inline mr-5 ml-5 mt-2">
                                                        <input type="radio" name="gioi_tinh" value="0"
                                                            style="display: inline">Nữ
                                                    </label>
                                            ...
                                            <div class="form-row mb-3">
                                                <div class="form-group col-md-6">
                                                    <label>Dân tộc</label>
                                                    <select id="dantoc" name="dan_toc" class="form-control"
                                                ...
                                                <div class="form-group col-md-6 mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="tongiao" name="ton_giao"
                                            ...
                                            <div class="form-row mb-3">
                                                <div class="form-group col-md-4">
                                                    ...
                                                    <input type="text" class="form-control" id="socmnd" name="so_cmnd"
                                                ...
                                                <div class="form-group col-md-4">
                                                    ...
                                                    <input type="text" class="form-control" name="noi_cap_cmnd"
                                                        placeholder="Nhập địa chỉ nơi cấp CMND" id="noicapcmnd">
                                ...
                                <div id="menu1" class="tab-pane fade">
                                    <div class="form-row mb-3">
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="text" class="form-control" id="sdtcanhan" name="sdt_ca_nhan"
                                                placeholder="Nhập số điện thoại cá nhân">
                                            <span id="sdtcanhanf"></span>
                                        </div>
                                        <div class="form-group col-md-4">
                                            <label>Số Điện Thoại Nhà</label>
                                            <input type="text" class="form-control" id="sdtnha" name="sdt_nha"
                                                placeholder="Nhập số điện thoại nhà">
                                            <span id="sdtnhaf"></span>
                                        </div>
                                        <div class="form-group col-md-4">
                                            <label for="email">Email Cá Nhân</label>
                                            <input type="email" class="form-control" id="emailcanhan" name="emailcanhan"
                                    ...
                                    <div class="form-row mb-3">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control mb-3" id="diachithuongtru"
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <select name="tinh_thuong_tru" class="form-control"
                                                style="-webkit-appearance: auto;" id="tinhthuongtru">
                                    ...
                                    <div class="form-row mb-3">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control mb-3" id="diachitamtru"
                                                name="dia_chi_tam_tru" placeholder="Nhập địa chỉ tạm trú" value="">
                                            <span id="diachitamtruf"></span>
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label>Tỉnh/ Thành phố</label>
                                            <select name="tinh_tam_tru" class="form-control"
                                                style="-webkit-appearance: auto;" id="tinhtamtru">
                                                <option selected value="" ">Chọn tỉnh</option>
                                                    @foreach($tinh as $t)
                                                    <option value=" {{$t->id_tinh}}">{{$t->ten_tinh}}</option>
                                                @endforeach
                                ...
                                <div id="menu2" class="tab-pane fade">
                                    <div class="form-row mb-3">
                                        <div class="form-group col-md-2">
                                            ...
                                            <select name="muc_trinh_do" class="form-control"
                                                style="-webkit-appearance: auto;" id="muctrinhdo">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control" name="noi_dao_tao"
                                                placeholder="Nhập nơi đào tạo" id="noidaotao">
                                            <span id="noidaotaof"></span>
                                        </div>
                                        <div class="form-group col-md-2">
                                            <label>Xếp loại</label>
                                            <select name="xep_loai" class="form-control"
                                                style="-webkit-appearance: auto;" id="xeploai">
                                        ...
                                        <div class="form-group col-md-2">
                                            ...
                                            <input type="number" name="nam_tot_nghiep" id="namtotnghiep"
                                                class="form-control text-center" min="2010" step="1" value="2023" />
                                    ...
                                    <div class="form-row mb-3">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control" id="nganhdaotao"
                                                name="nganh_dao_tao" placeholder="Nhập chuyên ngành đào tạo">
                                            <span id="nganhdaotaof"></span>
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label>Chuyên Ngành</label>
                                            <input type="text" class="form-control" id="chuyennganh" name="chuyen_nganh"
                                    ...
                                    <div class="form-row mb-3">
                                        <div class="form-group col-md-12">
                                            <label> Tên các bằng cấp, chứng chỉ khác (nếu không có ghi "Không")</label>
                                            ...
                                            <div class="icheck-inline">
                                                ...
                                                <label class="col-md-3 col-xs-6" style="margin: 0 0 10px 0;">
                                                    <input type="checkbox" name="hoso[]" value="{{$dshs->id_hoso}}"
                                                        data-checkbox="icheckbox_minimal-blue"> {{ $dshs->ten }}
                                                </label>
                                                @endforeach
                                            </div>
                                        </div>
                                ...
                                <div id="menu4" class="tab-pane fade">
                                    <div class="form-row mb-3">
                                        ...
                                        <div class="form-group col-md-4 mb-3">
                                            ...
                                            <input type="text" class="form-control" name="name" id="tennickname"
