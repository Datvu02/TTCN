     ...
     <div class="container-fluid  dashboard-content">
         ...
         <div class="row">
             <div class="col-lg-12 ">
                 ...
                 <a class="btn btn-primary mr-5 " href="{{url('private/laphopdong/pdf/'.$nhanvien->id_nhanvien)}}">Xuất
                     file PDF!!</a>
                 @endif
             </div>
         </div>
             ...
             <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                 <div class="card">
                     ...
                     <div class="card-body">
                         ...
                         <form class="needs-validation" action="{{url('private/laphopdong/'.$nhanvien->id_nhanvien)}}"
                                 ...
                                 <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                                     ...
                                     <div class="form-row mb-3">
                                         <div class="form-group col-md-6">
                                             ...
                                             <select id="ten_hop_dong" name="ten_hop_dong" class="form-control"
                                                 style="-webkit-appearance: auto;" required>
                                                 <option value="0"> Chọn Loại Hợp Đồng</option>
                                                 @foreach($loaihd as $lhd)
                                                 <option value="{{$lhd->id_loaihopdong}}">{{$lhd->ten_hop_dong}}
                                                 </option>
                                                 @endforeach
                                             </select>
                                     ...
                                     <div class="form-row mb-3 show ndthoivu" id="ndthoivu">
                                         ...
                                         <div class="form-group col-md-12">
                                             ...
                                             <textarea class="form-control" id="noi_dung" name="noi_dung_cv"
                                     ...
                                     <div class="show luong" id="luong">
                                         <div class="form-row mb-3 ">
                                             <div class="form-group col-md-6 mt-3">
                                                 ...
                                                 <input type="text" class="form-control" name="muc_luong_chinh"
                                                     placeholder="Nhập mức lương chính( lương cơ bản)" required>
                                             </div>
                                             <div class="form-group col-md-6">
                                                 <label>Phụ cấp với chức vụ: {{$nhanvien->tbl_chucvu->ten_chuc_vu}}
                                                 </label>
                                                 <div class="form-row mb-3">
                                                    ...
                                                    height: 2px;"></div>
                                                     ...
                                                     <div class="form-group col-md-3">
                                                         <label type="text" class="form-control text-center"
                                                             name="muc_luong_chinh">{{($phucap->an_trua)}}đ/tháng</label>
                                                         <label type="text" class="form-control text-center"
                                                             name="muc_luong_chinh">{{($phucap->xang_xe)}}đ/tháng</label>
                                                         <label type="text" class="form-control text-center"
                                                             name="muc_luong_chinh">{{($phucap->khac)}}đ/tháng</label>
                                                         <label type="text" class="form-control text-center mt-5"
                                                             name="muc_luong_chinh">{{($phucap->tong_tien_phu_cap)}}đ/tháng</label>
                                                     </div>
                                                 </div>
                                             </div>
                                             @endif
