            ...
            <div class="card">
                <div class="card-body">
                    <div class="btn-group">
                        ...
                        <a class="btn btn-info mb-3" href="{{url('private/lapphuluc/'.$hopdong->id_hopdong)}}"><i
                                class="fa fa-plus mr-2"></i>Thêm mới</a>

                    </div>
                    <!-- /.col-lg-12 -->
                    <table class="table table-striped table-bordered table-hover" id="data-tables1">
                        <thead>
                            <tr align="center">
                                <th>SỐ PHỤ LỤC</th>
                        ...
                        <tbody>
                            ...
                            <tr class="even gradeC" align="center">
                                ...
                                <td>
                                    <a class="btn btn-primary "
                                        href="{{url('private/chitietphuluc/'.$hopdong->id_hopdong.'/'.$pl->id_phuluc)}}"
                                        title="Chi tiết phụ lục"> <i class="fa fa-edit"></i> Xem</a>
                            ...
                            <td valign="top" colspan="5" class="dataTables_empty">Nhân viên có hợp đồng chưa có phụ luc
                            </td>
                            @endif
