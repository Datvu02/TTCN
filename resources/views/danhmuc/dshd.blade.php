        ...
        <div class="row">
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="page-header">
                    <h2 class="pageheader-title">Danh sách hợp đồng</h2>
                    ...
                    <table class="table table-striped table-bordered table-hover" id="data-tables">
                        ...
                        <tbody>
                            ...
                            <tr class="even gradeC" align="center">
                                ...
                                @if((date('m',strtotime($hd->ngay_bat_dau_hop_dong))-(date('m',strtotime($hd->ngay_ket_thuc_hop_dong))))
                                <=2) <td class="label label-danger">Sắp hết hạn </td>
                                    @else
