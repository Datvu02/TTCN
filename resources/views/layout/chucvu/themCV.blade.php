                 ...
                 <div class="card">
                     ...
                     <div class="card-body">
                         ...
                         <form name="myform" class="needs-validation" method="POST"
                             action="{{url('private/chucvu/them')}}" onsubmit="return validatechucvu()" novalidate>
                             {{ csrf_field() }}
                             <div class="row">
                                 <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                                     ...
                                     <div class="form-row">
                                         ...
                                         <div class="form-group col-md-8">
                                             <label for="id_chucvu">Mã Chức Vụ (VD: Nhân viên = NV, Trưởng phòng = TP)
                                             </label>
                                             <input type="text" class="form-control" id="id_machucvu" name="id_chucvu"
                                                 placeholder="Mã Chức vụ" value="" required>
