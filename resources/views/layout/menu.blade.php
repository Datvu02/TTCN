        ...
        <nav class="navbar navbar-expand-lg navbar-light">
            ...
            <li class="nav-item">
                <a class="nav-link" href="#" data-toggle="collapse" aria-expanded="false" data-target="#submenu-3"
                    aria-controls="submenu-3"><i class="fas fa-fw fa-chart-pie"></i>Hồ sơ nhân viên</a>
                <div id="submenu-3"
                    ...
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="#" data-toggle="collapse" data-target="#submenu-yk"
                                aria-controls="submenu-yk">Ý Kiến / Đề xuất</a>
                            <div id="submenu-yk"
                                ...
                                <ul class="nav flex-column">
                                    <li class="nav-item">
                                        <a class="nav-link {{Request::is('private/ykien/danhsach/theodoi') ? 'active':null}}"
                                            href="{{url('private/ykien/danhsach/theodoi')}}">Theo dõi ý kiến</a>
                                    </li>
                                    <li class="nav-item">
            ...
            <li class="nav-item ">
                <a class="nav-link" href="#" data-toggle="collapse" aria-expanded="false" data-target="#submenu-4"
                    aria-controls="submenu-4"><i class="fab fa-fw fa-wpforms"></i>Quản lý lương</a>
                <div id="submenu-4" class="collapse submenu {{Request::is('private/luong/danhsach') ? 'show':null}}"
                    style="">
                    <ul class="nav flex-column">
                        <li class="nav-item">
                    ...
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                            <a class="nav-link {{Request::is('private/tintuc/danhsachtuyendung') ? 'active':null}}"
                                href="{{url('private/tintuc/danhsachtuyendung')}}">Quản lý tin tuyển dụng</a>
                        </li>
                        <label>Tin tức</label>
                        <li class="nav-item">
