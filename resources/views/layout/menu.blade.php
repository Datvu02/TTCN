        ...
        <nav class="navbar navbar-expand-lg navbar-light">
            ...
            <li class="nav-item">
                <a class="nav-link" href="#" data-toggle="collapse" aria-expanded="false" data-target="#submenu-4"
                    aria-controls="submenu-4"><i class="fas fa-fw fa-chart-pie"></i>Quản lý ý kiến</a>
                <div id="submenu-4"
                    class="collapse submenu {{Request::is('private/ykien/danhsach/theodoi')||Request::is('private/ykien/them')||Request::is('private/loaiykien/danhsach')? 'show':null}}"
                    style="">
                    <ul class="nav flex-column">
                        <li class="nav-item">
