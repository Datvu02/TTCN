                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-3">
                                        ...
                                        <span class="form-control"
                                            name="loai_y_kien">{{$ykien->tbl_ykien->loai_y_kien}}</span>
                                    </div>
                                    ...
                                    <div class="form-group col-md-5">
                                        ...
                                        <span class="form-control"
                                            name="nguoi_lam_don">{{$ykien->tbl_hosonhanvien->ho_ten}}</span>
                                    </div>
                                    <div class="form-group col-md-3">
                                    ...
                                    $ykien->id_ykien == 4) && isset($ykien->thoi_gian_nghi))
                                    <div class="form-group col-md-4">
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <div class="form-control" name="ngay_bat_dau">
                                            {{date('d-m-Y',strtotime($ykien->ngay_bat_dau))}}</div>
                                    </div>
                                    <div class="form-group col-md-4">
                                        <label for="ngay_ket_thuc">Đến Ngày</label>
                                        <div class="form-control" name="ngay_ket_thuc">{{date('d-m-Y',
                                            strtotime($ykien->ngay_bat_dau ."+".$ykien->thoi_gian_nghi."days"))}}</div>
                                    </div>
                                    ...
                                    @endif
                                    @if($ykien->id_ykien == 5 || $ykien->id_ykien == 6|| $ykien->id_ykien == 9 ||
                                    $ykien->id_ykien == 10)
                                    ...
                                    <div class="form-group col-md-4">
                                        <label for="gia_tri">Giá Trị</label>
                                        <div class="form-control" name="gia_tri">{{number_format($ykien->gia_tri)}}
                                        </div>
                                    </div>
                                    @endif
                                    @endif
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <div class="form-control" name="ngay_duyet">{{date('H:i:s
                                            d/m/Y',strtotime($ykien->updated_at))}}</div>
                                    </div>
                                    @else
                                    <div class="form-group col-md-4">
                                        <label for="nguoi_duyet_2">Giám Đốc Duyệt</label>
