                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form class="needs-validation" method="POST"
                            action="{{url('private/ykien/sua/'.$ykien->id_luuykien)}}" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            <div class="row">
                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="text" class="form-control" id="id_ykien" name="id_ykien"
                                                placeholder="{{$ykien->tbl_ykien->loai_y_kien}}" disabled>
                                        </div>
                                        @if($ykien->id_ykien == 3)
                                        <div class="form-group col-md-3">
                                            ...
                                            <input type="text" class="form-control" id="loai" name="loai"
                                                placeholder="Đám Cưới" disabled>
                                            @elseif($ykien->truong_hop == 2)
                                            <input type="text" class="form-control" id="loai" name="loai"
                                                placeholder="Con Cái Kết Hôn" disabled>
                                            @else
                                            <input type="text" class="form-control" id="loai" name="loai"
                                                placeholder="Người Thân Mất" disabled>
                                            @endif
                                            <div class="text-muted">*Người Thân Mất* được tính theo pháp luật gồm: Bố
                                                đẻ, mẹ đẻ, bố vợ, mẹ vợ hoặc bố chồng, mẹ chồng, vợ hoặc chồng, con
                                            </div>
                                        </div>
                                        @endif
                                        @if($ykien->id_ykien == 2)
                                        <div class="form-group col-md-3">
                                            ...
                                            <select name="truong_hop" id="truong_hop" class="form-control"
                                    ...
                                    <select name="truong_hop" id="truong_hop" class="form-control col-md-3 "
                                        style="-webkit-appearance: auto;">
                                        <option selected> --Chọn--</option>
                                    ...
                                    <input type="text" class="form-control " name="thoi_gian_nghi"
                                        value="{{$ykien->thoi_gian_nghi}}">
                                    @endif
                                    @if($ykien->id_ykien == 1 || $ykien->id_ykien == 2 || $ykien->id_ykien == 3 ||
                                    $ykien->id_ykien == 4 || $ykien->id_ykien == 7 )
                                    @if($ykien->id_ykien == 7)
                                    ...
                                    <input type="date" class="form-control" name="ngay_bat_dau"
                                        value="{{date('Y-m-d',strtotime($ykien->ngay_bat_dau))}}">
                                    @endif
                                    @if(isset($hinhanh))
                                    <div class="form-row">
                                        ...
                                        <div class="img-thumbnail">
                                            <a href="{{url('upload/anhminhchung/'.$anh->ten_anh)}}" target="_blank"><img
                                                    src="{{url('upload/anhminhchung/'.$anh->ten_anh)}}"
                                                    style="width: 255px;height: 265px;" class="magnify"></a>
                                        </div>
                                        @endforeach
                                    </div>
                                    @endif
                                    <label for="nop_minh_chung">Bổ Sung Minh Chứng (Hình Ảnh)</label>
                                    <input type="file" class="form-control" name="nop_minh_chung[]"
