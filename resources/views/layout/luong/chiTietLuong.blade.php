...
<div class="dashboard-wrapper">
    <div class="container-fluid  dashboard-content">
                    ...
                    <div class="page-breadcrumb">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Chi tiết lương</li>
                            </ol>
                        </nav>
                    </div>
                </div>
        ...
        <div class="row">
            ...
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="card">
                    <h5 class="card-header">Chi Tiết Lương Tháng {{date('m',strtotime($luong->luong_thang))}} Của
                        {{$luong->tbl_hosonhanvien->ho_ten}}</h5>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                                <div class="form-row">
                                    <div class="form-group col-md-2">
                                        ...
                                        <span class="form-control"
                                            name="luong_tongma_nv">{{$nhanvien->id_nhanvien}}</span>
                                    </div>
                                    <div class="form-group col-md-2">
                                    ...
                                    <div class="form-group col-md-2">
                                        ...
                                        <span class="form-control"
                                            name="chucvu_phongban">{{$nhanvien->tbl_chucvu->ten_chuc_vu}} </span>
                                    </div>
                                </div>
                                <div class="form-row">
                                    <div class="form-group col-md-2">
                                        ...
                                        <span class="form-control"
                                            name="luong_tong">{{number_format($luong->tong_tien_luong)}}</span>
                                    </div>
                                    <div class="form-group col-md-2">
                                        <label for="luong_co_ban">Lương Cơ Bản</label>
                                        <span class="form-control"
                                            name="luong_co_ban">{{number_format($luongcoban)}}</span>
                                    </div>
                                    <div class="form-group col-md-2">
                                        <label for="so_gio_lam_viec">Ca Làm Việc Trong Tháng</label>
                                        <span class="form-control"
                                            name="so_gio_lam_viec">{{round($luong->so_gio_lam_viec,2)}}</span>
                                    </div>
                                </div>
                                <label class="mt-4">Phụ cấp</label>
                                <div class="form-row">
                                    <div class="form-group col-md-3">
                                        <label for="an_trua">Ăn Trưa</label>
                                        <span class="form-control"
                                            name="an_trua">{{number_format($phucap->an_trua)}}</span>
                                    </div>
                                    <div class="form-group col-md-3">
                                ...
                                <label class="mt-4">Thuế</label>
                                <div class="form-row">
                                    <div class="form-group col-md-3">
                                        <label for="thue_thu_nhap">Thuế Thu Nhập Phải Đóng</label>
                                        <span class="form-control"
                                            name="thue_thu_nhap">{{number_format($luong->thue_thu_nhap)}}</span>
                                    </div>
                                    <div class="form-group col-md-3">
                                        <label for="thue_bao_hiem">Thuế Bảo Hiểm Y Tế</label>
                                        <span class="form-control"
                                            name="thue_bao_hiem">{{number_format($thuebhyt)}}</span>
                                    </div>
                                    <div class="form-group col-md-3">
                                        <label for="thue_bao_hiem">Thuế Bảo Hiểm Xã Hội</label>
                                        <span class="form-control"
                                            name="thue_bao_hiem">{{number_format($thuebhxh)}}</span>
                                    </div>
                                    <div class="form-group col-md-3">
                                        <label for="thue_bao_hiem">Thuế Bảo Hiểm Thất Nghiệp</label>
                                        <span class="form-control"
                                            name="thue_bao_hiem">{{number_format($thuebhtn)}}</span>
                                    </div>
                                </div>
                                <label class="mt-4">Thưởng phạt</label>
                                <div class="form-row">
                                    <div class="form-group col-md-3">
                                    ...
                                    <div class="form-group col-md-3">
                                        ...
                                        <span class="form-control" name="ky_luat">{{($kyluatt)}}</span>
                                    </div>
                                </div>
                                <div class="form-row">
                                    @if($thuong!=null)
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-4">
                                        ...
                                        <small id="helper" class="text-muted">Cập nhật lần cuối vào : {{date('H:i:s
                                        d/m/Y',strtotime($luong->updated_at))}}</small>
                                        <div>
                                        </div>
                                    </div>
                                </div>
