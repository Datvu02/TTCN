            ...
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form class="needs-validation" action="thongtintaikhoan" method="POST"
                            ...
                            <div class="tab-content">
                                                ...
                                                <div class="form-group col-md-12">
                                                    <div class="form-row mb-3">
                                                        <div class="form-group col-md-12">
                                                            ...
                                                            <label
                                                                class="form-control mb-3">{{$nhanvien->ho_ten}}</label>
                                                        </div>

                                                        <div class="form-group col-md-6">
                                                            <label for="ngaysinh">Ngày Sinh</label>
                                                            <label
                                                                class="form-control mb-3">{{$nhanvien->ngay_sinh}}</label>
                                                        </div>
                                                        <div class="form-group col-md-6 mb-3">
                                                            ...
                                                            <label class="radio-inline mr-5 ml-5 mt-2">
                                                                ...
                                                                <input type="radio" name="gioi_tinh" value="1"
                                                                    checked="" style="display: inline">Nam
                                                                @else
                                                                <input type="radio" name="gioi_tinh" value="0"
                                                                    checked="" style="display: inline">Nữ
                                                                @endif
                                                            </label>
                                                        </div>
                                                        ...
                                                        <div class="form-group col-md-6">
                                                            <label>Dân tộc</label>
                                                            <label
                                                                class="form-control ">{{$nhanvien->tbl_dantoc->ten_dan_toc}}</label>
                                                        </div>
                                                        <div class="form-group col-md-6 ">
                                                            <label>Tôn giáo</label>
                                                            <label
                                                                class="form-control mb-3">{{$nhanvien->ton_giao}}</label>
                                                        </div>
                                                    ...
                                                    <div class="form-row mb-3">
                                                        <div class="form-group col-md-4">
                                                            ...
                                                            <label
                                                                class="form-control mb-3">{{$nhanvien->so_cmnd}}</label>
                                                        </div>
                                                        <div class="form-group col-md-4">
                                                            <label for="ngaycapcmnd">Ngày Cấp</label>
                                                            <label
                                                                class="form-control mb-3">{{$nhanvien->ngay_cap_cmnd}}</label>
                                                        </div>
                                                        <div class="form-group col-md-4">
                                                            <label for="noicapcmnd">Nơi Cấp</label>
                                                            <label
                                                                class="form-control mb-3">{{$nhanvien->noi_cap_cmnd}}</label>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="form-group col-md-12 mb-3">
                                            ...
                                            <div class="icheck-inline">
                                                ...
                                                <label class="col-md-3 col-xs-6" style="margin: 0 0 10px 0;">
                                                    <input type="checkbox" name="hoso_id[]" value="{{$dshs->id_hoso}}"
                                                        data-checkbox="icheckbox_minimal-blue" class="icheck" {{
                                                        (in_array($dshs->id_hoso, $ho_so))?"checked":"" }} readonly> {{
                                                    $dshs->ten }} </label>
                                                @endforeach
                                            </div>
                                            @endif
                                ...
                                <div id="menu4" class="tab-pane fade">
                                    ...
                                    @if(isset($phuluc))
                                    <p style="font-size: 16px;color: black; ">Vị trí làm việc được thay đổi vào ngày:
                                        {{date('d-m-Y',strtotime($phuluc->tbl_chitietphuluc->ngay_bat_dau))}}</p>
                                    ...
                                    <div class="form-row mb-3">
                                        ...
                                        <div class="form-group col-md-4 mb-3">
                                            <label>Chức Vụ</label>
                                            <label
                                                class="form-control mb-3">{{$phuluc->tbl_chitietphuluc->tbl_chucvu->ten_chuc_vu}}</label>
                                        </div>
                                                            ...
                                                            <div class="form-row mb-3">
                                                                ...
                                                                <div class="form-group col-md-6">
                                                                    ...
                                                                    <input type="password" class="form-control password"
                                                                        name="password" placeholder="Hãy nhập mật khẩu"
                                                                        disabled="" />
                                                                </div>
                                                                <div class="form-group col-md-6">
                            ...
                            <a class="btn btn-primary mr-5 "
                                href="{{url('private/suathongtin/'.Auth::user()->id_nhanvien)}}">Sửa đổi thông tin</a>
                        </form>
